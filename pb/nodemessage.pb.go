...
// sync txn pool
type RplTxnPoolHash struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TxnCount uint32 `protobuf:"varint,1,opt,name=txn_count,json=txnCount,proto3" json:"txn_count,omitempty"`
	PoolHash []byte `protobuf:"bytes,2,opt,name=pool_hash,json=poolHash,proto3" json:"pool_hash,omitempty"`
}

func (x *RplTxnPoolHash) Reset() {
	*x = RplTxnPoolHash{}
	if protoimpl.UnsafeEnabled {
...
func (x *RplTxnPoolHash) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RplTxnPoolHash) ProtoMessage() {}

func (x *RplTxnPoolHash) ProtoReflect() protoreflect.Message {
	mi := &file_pb_nodemessage_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RplTxnPoolHash.ProtoReflect.Descriptor instead.
func (*RplTxnPoolHash) Descriptor() ([]byte, []int) {
	return file_pb_nodemessage_proto_rawDescGZIP(), []int{27}
}

func (x *RplTxnPoolHash) GetTxnCount() uint32 {
	if x != nil {
		return x.TxnCount
	}
	return 0
...
func (x *RplTxnPoolHash) GetPoolHash() []byte {
	if x != nil {
		return x.PoolHash
	}
	return nil
...
func (x *ReqSyncTxnPool) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReqSyncTxnPool) ProtoMessage() {}

func (x *ReqSyncTxnPool) ProtoReflect() protoreflect.Message {
	mi := &file_pb_nodemessage_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReqSyncTxnPool.ProtoReflect.Descriptor instead.
func (*ReqSyncTxnPool) Descriptor() ([]byte, []int) {
	return file_pb_nodemessage_proto_rawDescGZIP(), []int{29}
}

func (x *ReqSyncTxnPool) GetDuration() int64 {
	if x != nil {
		return x.Duration
	}
	return 0
...
func (x *ReqSyncTxnPool) GetAddrNonce() []*AddrNonce {
	if x != nil {
		return x.AddrNonce
	}
	return nil
...
func (x *TxnWithDuration) Reset() {
	*x = TxnWithDuration{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_nodemessage_proto_msgTypes[30]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TxnWithDuration) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TxnWithDuration) ProtoMessage() {}

func (x *TxnWithDuration) ProtoReflect() protoreflect.Message {
	mi := &file_pb_nodemessage_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TxnWithDuration.ProtoReflect.Descriptor instead.
func (*TxnWithDuration) Descriptor() ([]byte, []int) {
	return file_pb_nodemessage_proto_rawDescGZIP(), []int{30}
}

func (x *TxnWithDuration) GetTxn() *Transaction {
	if x != nil {
		return x.Txn
	}
	return nil
...
func (x *TxnWithDuration) GetDuration() int64 {
	if x != nil {
		return x.Duration
	}
	return 0
...
type RplSyncTxn struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Transactions []*TxnWithDuration `protobuf:"bytes,1,rep,name=transactions,proto3" json:"transactions,omitempty"`
}

func (x *RplSyncTxn) Reset() {
	*x = RplSyncTxn{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pb_nodemessage_proto_msgTypes[31]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RplSyncTxn) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RplSyncTxn) ProtoMessage() {}

func (x *RplSyncTxn) ProtoReflect() protoreflect.Message {
	mi := &file_pb_nodemessage_proto_msgTypes[31]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RplSyncTxn.ProtoReflect.Descriptor instead.
func (*RplSyncTxn) Descriptor() ([]byte, []int) {
	return file_pb_nodemessage_proto_rawDescGZIP(), []int{31}
}

func (x *RplSyncTxn) GetTransactions() []*TxnWithDuration {
	if x != nil {
		return x.Transactions
	}
	return nil
...
var file_pb_nodemessage_proto_rawDesc = []byte{
	...
	0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0x4a, 0x0a, 0x0e, 0x52, 0x70, 0x6c, 0x54, 0x78, 0x6e,
	0x50, 0x6f, 0x6f, 0x6c, 0x48, 0x61, 0x73, 0x68, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x78, 0x6e, 0x5f,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x74, 0x78, 0x6e,
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x70, 0x6f, 0x6f, 0x6c, 0x5f, 0x68, 0x61,
	0x73, 0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x70, 0x6f, 0x6f, 0x6c, 0x48, 0x61,
	0x73, 0x68, 0x22, 0x3b, 0x0a, 0x09, 0x41, 0x64, 0x64, 0x72, 0x4e, 0x6f, 0x6e, 0x63, 0x65, 0x12,
	...
	,
	...
	0x28, 0x03, 0x52, 0x08, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x45, 0x0a, 0x0a,
	0x52, 0x70, 0x6c, 0x53, 0x79, 0x6e, 0x63, 0x54, 0x78, 0x6e, 0x12, 0x37, 0x0a, 0x0c, 0x74, 0x72,
	0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x13, 0x2e, 0x70, 0x62, 0x2e, 0x54, 0x78, 0x6e, 0x57, 0x69, 0x74, 0x68, 0x44, 0x75, 0x72,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0c, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x2a, 0xc3, 0x06, 0x0a, 0x0b, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x54,
...
var file_pb_nodemessage_proto_msgTypes = make([]protoimpl.MessageInfo, 32)
var file_pb_nodemessage_proto_goTypes = []interface{}{
	...
	(*RplTxnPoolHash)(nil),                        // 36: pb.RplTxnPoolHash
	(*AddrNonce)(nil),                             // 37: pb.AddrNonce
	(*ReqSyncTxnPool)(nil),                        // 38: pb.ReqSyncTxnPool
	(*TxnWithDuration)(nil),                       // 39: pb.TxnWithDuration
	(*RplSyncTxn)(nil),                            // 40: pb.RplSyncTxn
	(*Block)(nil),                                 // 41: pb.Block
	(*Transaction)(nil),                           // 42: pb.Transaction
	(SyncState)(0),                                // 43: pb.SyncState
	(*Header)(nil),                                // 44: pb.Header
	(*SigChainElem)(nil),                          // 45: pb.SigChainElem
}
var file_pb_nodemessage_proto_depIdxs = []int32{
	...
	41, // 2: pb.RequestBlockProposalReply.block:type_name -> pb.Block
	8,  // 3: pb.RequestProposalTransactions.type:type_name -> pb.RequestTransactionType
	42, // 4: pb.RequestProposalTransactionsReply.transactions:type_name -> pb.Transaction
	43, // 5: pb.GetConsensusStateReply.sync_state:type_name -> pb.SyncState
	44, // 6: pb.GetBlockHeadersReply.block_headers:type_name -> pb.Header
	41, // 7: pb.GetBlocksReply.blocks:type_name -> pb.Block
	23, // 8: pb.GetStates.reqs:type_name -> pb.StateRequest
	24, // 9: pb.GetStatesReply.nodes:type_name -> pb.StateNode
	42, // 10: pb.Transactions.transactions:type_name -> pb.Transaction
	45, // 11: pb.BacktrackSignatureChain.sig_chain_elems:type_name -> pb.SigChainElem
	42, // 12: pb.RequestSignatureChainTransactionReply.transaction:type_name -> pb.Transaction
	37, // 13: pb.ReqSyncTxnPool.addrNonce:type_name -> pb.AddrNonce
	42, // 14: pb.TxnWithDuration.txn:type_name -> pb.Transaction
	39, // 15: pb.RplSyncTxn.transactions:type_name -> pb.TxnWithDuration
...
func file_pb_nodemessage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pb_nodemessage_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TxnWithDuration); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pb_nodemessage_proto_msgTypes[31].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RplSyncTxn); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
